...
export const MENU_TITLES = {
    ...
    '/admin/departments': { default: '학과 목록' },
    ...
    '/admin/application-management/info-change-requests': { default: '정보 변경 신청 목록' },
    '/admin/application-management/leave-requests': { default: '휴·복학 신청 목록' },
    ...
    '/graduation-diagnoses': { default: '졸업요건 진단 현황', PROFESSOR: '학생 졸업요건 현황' },
    ...
    '/professor/evaluations': { default: '강의평가 결과' },
...
export const MENU_TITLES_BY_NAME = {
    ...
    AdminDepartmentDetail: '학과 상세 및 수정',
    AcademicScheduleDetail: '학사일정 상세 · 수정',
    AdminNoticeEdit: '공지사항 상세 · 수정',
    AdminInfoChangeRequestDetail: '정보 변경 신청 상세',
    AdminLeaveRequestDetail: '휴·복학 신청 상세',
    TuitionShow: '등록금 상세',
