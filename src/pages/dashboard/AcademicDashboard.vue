...
<template>
  <MyPageContainer :title="dashboardTitle">
    <div class="dashboard">
      <div class="left">
        <MyCard
          v-if="dashboardStore.isSchedulesLoading"
          class="status-msg"
        >
          일정을 불러오는 중입니다...
        </MyCard>
        <MyCard
          v-else-if="dashboardStore.isSchedulesError"
          class="status-msg error"
        >
          일정을 불러오지 못했습니다. <button
            type="button"
            @click="dashboardStore.loadSchedules()"
          >
            재시도
          </button>
        </MyCard>
      ...
      <div class="right">
        <MyCard
          v-if="dashboardStore.isNoticesLoading"
          class="status-msg"
        >
          공지사항을 불러오는 중입니다...
        </MyCard>
        <MyCard
          v-else-if="dashboardStore.isNoticesError"
          class="status-msg error"
        >
          공지사항을 불러오지 못했습니다. <button
            type="button"
            @click="dashboardStore.loadNotices()"
          >
            재시도
          </button>
        </MyCard>
